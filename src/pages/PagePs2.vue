...
import WindowItemPs2Disc from '@/dialog-components/ps2/WindowItemPs2Disc.vue';
import ItemPs2Disc from '@/page-components/ps2/ItemPs2Disc.vue';
...
const currentDisc = computed(() => {
  let xCurrentDiscCode =
    typeof currentDiscCode.value === 'string' ? currentDiscCode.value.trim().toLowerCase() : '';
    ...
    <div class="PagePs2-body">
      ...
      <div class="PagePs2-main" v-if="ps2Discs.length">
        ...
        <div class="PagePs2-section transition">
          <p v-if="!ps2Discs.length" class="PagePs2-section-description">No Item</p>
          <div class="PagePs2-item-list">
            <div v-for="ps2Disc in ps2Discs" :key="ps2Disc.code" class="PagePs2-item-body">
      ...
      <Empty v-if="!ps2Discs.length && !isLoading" :icon="$options.icon.dark.toUrl()" />
