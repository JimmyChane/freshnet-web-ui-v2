...
import Section from '@/page-components/profile/PageProfile-Section.vue';
import SectionTitle from '@/page-components/profile/PageProfile-Section-Title.vue';
import SectionMain from '@/page-components/profile/PageProfile-Section-Main.vue';
import WindowChangePassword from '@/dialog-components/profile/WindowChangePassword.vue';
...
function openWindowChangePassword() {
  usePopupWindowStore().open({ component: WindowChangePassword });
}
