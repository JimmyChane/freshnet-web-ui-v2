...
const key = ref(SettingKey.CompanyWorkingHours);
...
<template>
  <div class="ItemSettingBusinessHours">
    ...
    <div class="ItemSettingBusinessHours-body">
      <BusinessHoursItem v-for="value of values" :key="value.title" :value="value as WorkingDay" />
      <span class="ItemSettingBusinessHours-empty" v-if="!values.length">Empty</span>
    </div>
  </div>
</template>
