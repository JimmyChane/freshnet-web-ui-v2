  ...
  >
    <div class="SectionCategory">
      <div class="SectionCategory-item" v-if="category">
        <img class="SectionCategory-item-icon" v-if="categoryIconUrl" :src="categoryIconUrl" />
        <span class="SectionCategory-item-title" v-if="categoryTitle">{{ categoryTitle }}</span>
      </div>
