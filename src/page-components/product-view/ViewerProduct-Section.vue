...
const props = withDefaults(defineProps<{ title?: string; menu?: Menu; primaryColor?: Color }>(), {
  title: '',
});

const titleColor = computed(() => props.primaryColor?.mix('000000', 0.9).toString() ?? '#4E504D');
</script>
