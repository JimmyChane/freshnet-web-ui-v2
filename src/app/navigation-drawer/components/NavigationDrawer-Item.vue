...
<template>
  <div class="LeftNavItem" :isSelected="`${isSelected}`" :isWide="`${isWide}`">
    <IconHome class="LeftNavItem-icon" v-if="key === 'home'" :isSelected="isSelected" />
    <IconProducts class="LeftNavItem-icon" v-else-if="key === 'product'" :isSelected="isSelected" />
    <IconPaper class="LeftNavItem-icon" v-else-if="key === 'print'" :isSelected="isSelected" />
    <IconManage class="LeftNavItem-icon" v-else-if="key === 'manage'" :isSelected="isSelected" />
    <IconProfile class="LeftNavItem-icon" v-else-if="key === 'profile'" :isSelected="isSelected" />
    <IconCustomers
      class="LeftNavItem-icon"
      v-else-if="key === 'customer'"
      :isSelected="isSelected"
    />
    <IconService class="LeftNavItem-icon" v-else-if="key === 'service'" :isSelected="isSelected" />
    <IconOrder class="LeftNavItem-icon" v-else-if="key === 'order'" :isSelected="isSelected" />
    <IconUsers class="LeftNavItem-icon" v-else-if="key === 'users'" :isSelected="isSelected" />
    <IconDatabase
      class="LeftNavItem-icon"
      v-else-if="key === 'database'"
      :isSelected="isSelected"
    />
    <IconSetting class="LeftNavItem-icon" v-else-if="key === 'setting'" :isSelected="isSelected" />
    <img class="LeftNavItem-icon" v-else-if="iconUrl" :src="iconUrl" />
    <span class="LeftNavItem-title" v-if="iconUrl ? isWide && title.length : true">
      {{ title }}
    </span>
  </div>
</template>
