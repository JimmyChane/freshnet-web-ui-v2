...
import ItemBelonging from '@/page-components/service/ItemBelonging.vue';
  ...
  <div class="PanelService-actionbar">
    <Actionbar
      ...
      :style="{
        ...
        'border-bottom': `1px solid ${isExpand ? actionbarBorder : 'transparent'}`,
      }"
      :leftMenus="{
        icon: IconClose,
      ...
      :rightMenus="menus"
    >
      <button class="PanelService-actionbar-actionbar-clickable" @click="() => toggleExpand()">
        <PanelItemCustomer
          v-if="customer"
          :customer="customer"
          :isEditable="isExpand"
          ...
          <div class="PanelService-actionbar-expanded-body-body">
            <div class="PanelService-section-labels">
              ...
              <MenuIconVue
                ...
                :src="bookmarkHeaderIconIsHover ? IconBookmark : IconBookmarkAdd"
              />
            </div>
