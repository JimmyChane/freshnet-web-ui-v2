...
import ItemSpecification from '@/page-components/customer/ItemSpecification.vue';
...
<template>
  ...
  >
    <div class="WindowUpdateDeviceDescription-body">
      <div class="WindowUpdateDeviceDescription-specification" v-if="specifications.length">
        <ItemSpecification
