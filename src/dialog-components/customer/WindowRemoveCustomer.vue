    ...
    <div class="WindowRemoveCustomer-body" v-if="item">
      ...
      <div class="WindowRemoveCustomer-namePhoneNumber">
        <div class="WindowRemoveCustomer-namePhoneNumber-section" v-if="item.name">
          <span class="WindowRemoveCustomer-namePhoneNumber-section-header">Name</span>
          <span class="WindowRemoveCustomer-namePhoneNumber-section-content">{{ item.name }}</span>
        </div>

        <div class="WindowRemoveCustomer-namePhoneNumber-section" v-if="item.phoneNumber">
          <span class="WindowRemoveCustomer-namePhoneNumber-section-header">Phone Number</span>
      ...
      <div class="WindowRemoveCustomer-description" v-if="item.description">
        ...
        <span class="WindowRemoveCustomer-description-body">{{ item.description }}</span>
      </div>
    </div>
  </PanelAction>
</template>
