...
<template>
  ...
  >
    <div class="WindowChangePassword">
      ...
      <Input type="password" label="New Password" :isRequired="true" v-model="passwordNew" />

      <Input type="password" label="Repeat Password" :isRequired="true" v-model="passwordRepeat" />
    </div>
  </PanelAction>
</template>
