...
import ItemButton from '@/panel-components/manage/PanelItems-ItemButton.vue';
  ...
  >
    <div v-if="isGrid" :class="['transition', 'ItemService-body']">
      <div class="ItemService-top">
        <ItemServiceCustomer v-if="headerCustomer" :name="name" :phoneNumberStr="phoneNumberStr" />
    ...
    <div v-if="isList" :class="['transition', 'ItemService-body']">
      <div class="ItemService-top">
        <ItemServiceTimestamp class="ItemService-timestamp" :service="item" :line="1" />
        <ItemServiceCustomer
    ...
    <div v-if="isDetail" :class="['transition', 'ItemService-body']">
      ...
      <ItemServiceDetailColumn :width="getPropertyByKey('customerPhoneNumber')?.width">
        {{ phoneNumberStr }}
      </ItemServiceDetailColumn>
