...
function clickCustomerSuggestion(customer: Customer) {
  ...
  data.value.customer.phoneNumber = customer.phoneNumber ? customer.phoneNumber.toString() : '';
}
...
<template>
  ...
  >
    <div class="WindowService-body">
      <BodyUser :name="data.nameOfUser" @input-name="(value) => (data.nameOfUser = value)" />
